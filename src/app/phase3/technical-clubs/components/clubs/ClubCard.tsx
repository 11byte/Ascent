...
> = {
  ...
  fuchsia: {
    ...
    gradientEnd: "to-fuchsia-300",
    buttonBg: "bg-fuchsia-600 hover:bg-fuchsia-700 shadow-lg",
    iconBorder: "border-fuchsia-500/50",
  },
  cyan: {
    borderColor: "border-cyan-500/60",
    shadowColor: "shadow-cyan-500/20",
    gradientEnd: "to-cyan-300",
    buttonBg: "bg-cyan-600 hover:bg-cyan-700 shadow-lg",
    iconBorder: "border-cyan-500/50",
  },
  red: {
    borderColor: "border-red-500/60",
    shadowColor: "shadow-red-500/20",
    gradientEnd: "to-red-300",
    buttonBg: "bg-red-600 hover:bg-red-700 shadow-lg",
    iconBorder: "border-red-500/50",
  },
  lime: {
    borderColor: "border-lime-500/60",
    shadowColor: "shadow-lime-500/20",
    gradientEnd: "to-lime-300",
    buttonBg: "bg-lime-600 hover:bg-lime-700 shadow-lg",
    iconBorder: "border-lime-500/50",
  },
  blue: {
    borderColor: "border-blue-500/60",
    shadowColor: "shadow-blue-500/20",
    gradientEnd: "to-blue-300",
    buttonBg: "bg-blue-600 hover:bg-blue-700 shadow-lg",
...
interface ClubCardProps {
  club: Club;
  index: number;
  phaseNo: number; // Added phaseNo for potential future use
}

export default function ClubCard({ club, index, phaseNo }: ClubCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Card
          className={`relative rounded-3xl bg-gray-900/70 backdrop-blur-xl ${cardBorderClass} transition duration-300 overflow-hidden ${cardHoverShadowClass}`}
        >
          ...
          <CardContent className="p-8 flex flex-col items-center text-center text-white">
            ...
            <h2
              className={`mt-6 text-2xl font-bold text-transparent bg-clip-text ${titleGradientClass}`}
            >
              {club.name}
            </h2>
            ...
            <motion.div whileTap={{ scale: 0.95 }} className="w-full mt-6">
              ...
              <Link href={`/phase${phaseNo}/technical-clubs/${club.domain}`}>
                <Button
                  variant="default"
