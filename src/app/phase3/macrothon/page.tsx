...
const theme = {
  name: "Accelerate",
  accent: "#F5B700", // amber highlight (primary actions)
  border: "#2C317D", // deep blue border (refined from #3338A0)
  soft: "rgba(245,183,0,0.08)", // amber glow layer
  depth: "#15184A", // deep blue background tone
};
