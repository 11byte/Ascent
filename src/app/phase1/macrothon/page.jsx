  ...
  const dailyChallenges = [
    {
      ...
      description:
        "Create a secure login system with email/password authentication and session management.",
      requirements: [
        "Password hashing",
        "Session tokens",
        "Input validation",
    ...
    },
    {
      ...
      difficulty: "Beginner",
      description:
        "Build a responsive admin dashboard with charts and data tables.",
      requirements: [
        "Mobile-first design",
        "Chart integration",
        "Data fetching",
    ...
    },
    {
      ...
      difficulty: "Intermediate",
      description:
        "Develop a complete REST API for a todo application with CRUD operations.",
      requirements: [
        "GET/POST/PUT/DELETE",
        "Data validation",
        "Error handling",
    ...
    },
    {
      ...
      difficulty: "Advanced",
      description:
        "Create a visualizer for sorting algorithms with real-time animation.",
      requirements: [
        "Multiple algorithms",
        "Visual animation",
        "Performance metrics",
    ...
    },
    {
      ...
      difficulty: "Beginner",
      description:
        "Build a real-time password strength analyzer with visual feedback.",
      requirements: [
    ...
    },
    {
      ...
      difficulty: "Intermediate",
      description:
        "Create an eye-catching landing page with smooth scroll animations and parallax effects.",
      requirements: [
        "Scroll animations",
        "Parallax effects",
        "Responsive design",
    ...
    },
    {
      ...
      difficulty: "Advanced",
      description:
        "Build a real-time chat server with WebSocket support and message persistence.",
      requirements: [
        "Real-time messaging",
        "User authentication",
        "Message history",
    ...
    },
    {
      ...
      difficulty: "Advanced",
      description:
        "Optimize slow database queries and improve database performance by 10x.",
      requirements: [
        "Index optimization",
        "Query analysis",
        "Execution plans",
    ...
    },
    {
      ...
      difficulty: "Intermediate",
      description:
        "Implement a balanced binary search tree with insertion, deletion, and traversal operations.",
      requirements: [
        "Tree balancing",
        "CRUD operations",
        "Tree traversal",
    ...
    >
          ...
          <defs>
            ...
            >
              <stop
                offset="0%"
                style={{
                  stopColor: darkMode ? "#3b82f6" : "#60a5fa",
                  stopOpacity: 0,
                }}
              />
              <stop
                offset="50%"
                style={{
                  stopColor: darkMode ? "#06b6d4" : "#22d3ee",
                  stopOpacity: 0.4,
                }}
              />
              <stop
            ...
            >
              <stop
                offset="0%"
                style={{
                  stopColor: darkMode ? "#8b5cf6" : "#a78bfa",
                  stopOpacity: 0,
                }}
              />
              <stop
        ...
        {activeTab === "challenges" ? (
          <>
            ...
            <div className="mb-8 text-center">
              ...
              >
                Solve real-world programming problems. Build portfolio projects.
          ...
          <div>
            <div className="mb-8 text-center">
              ...
              >
                Top coders ranked by their problem-solving skills and
                consistency
              </p>
            </div>
      ...
      {showSubmission && currentChallenge && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div
            className={`rounded-2xl max-w-2xl w-full p-8 shadow-2xl border ${
              darkMode
