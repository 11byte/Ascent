...
import { Cloud, Users, Rocket, Calendar, ArrowLeft, Code } from "lucide-react";
...
const club = {
  ...
  description:
    "Aether Cloud Ops focuses on cloud computing, container orchestration, and scalable infrastructure. Members learn to design resilient systems using Kubernetes, Docker, Terraform and CI/CD pipelines while following modern DevOps and SRE practices.",
  ...
  activities: [
    "Weekly Kubernetes & Docker Hands-On Labs",
    "Cloud Security & Observability Workshops",
  ...
  projects: [
    {
      ...
      description:
        "Automated build and deployment pipeline built using GitHub Actions, Docker, and Kubernetes.",
    },
    {
      title: "Cloud Monitoring Stack",
      description:
        "Full observability stack using Prometheus, Grafana, and Loki for monitoring cloud infrastructure.",
    },
    {
      title: "Terraform Infrastructure Kit",
      description:
        "Reusable Terraform modules to quickly deploy scalable AWS infrastructure.",
    },
  ],
};
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white px-6 lg:px-20 py-20">
      ...
      <section className="relative max-w-6xl mx-auto mb-20">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-500/20 blur-[180px] rounded-full"></div>
        ...
        >
          ...
          <h1 className="text-5xl font-bold text-cyan-400">{club.name}</h1>
      ...
      <section className="max-w-6xl mx-auto mb-20">
        <h2 className="text-3xl font-bold mb-8 text-cyan-400">Core Team</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {club.coreMembers.map((member, i) => (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-cyan-500/20 flex items-center justify-center text-xl font-bold text-cyan-400 mb-4">
      ...
      <section className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {club.activities.map((activity, i) => (
            ...
            >
              <Code className="w-4 h-4 text-cyan-400 mt-1" />
