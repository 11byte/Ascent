...
export default function Phase2GitHubTrackerPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden pt-24">
      ...
      <HomeBackground username={userId} background="#450C1C" />
        ...
        {loading ? (
          <div className="flex justify-center items-center h-96">
            <motion.div
              ...
              style={{
                border: `4px solid ${phase2Theme.tBorder.light}`,
          ...
          <GitHubTracker githubToken={token} userId={userId} phase="phase2" theme={phase2Theme} />
        )}
      </div>
    </div>
  );
