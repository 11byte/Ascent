          ...
          {rankings.map((item: string, index: number) => (
            ...
            >
              <div className="flex items-center">
                <span
                  style={{ color: theme.tColor.light }}
                  className="text-lg font-bold mr-4 min-w-8"
                >
                  {index + 1}.
                </span>
    ...
    <div className="space-y-6">
          ...
          <div className="space-y-2">
            {useCases.map((useCase: string, index: number) => (
              <motion.button
                ...
                whileHover={{
                  scale:
                    selectedTech && !Object.values(matches).includes(useCase)
                      ? 1.02
                      : 1,
                }}
                disabled={
      ...
      {selectedTech && (
        <div
          ...
          className="p-4 mb-2"
        >
          Selected: <strong>{selectedTech}</strong> - Click on a use case to
          match
        </div>
      )}
        ...
        {paths.map((path: any, index: number) => (
          <motion.div
            ...
            style={{
              ...
              background:
                selectedPath === path ? theme.tDepthColor.light : "#fff",
              color: theme.tColor.light,
              borderRadius: 16,
            }}
            className="p-6 rounded-xl cursor-pointer transition-all"
      ...
      <ThemeCard theme={theme}>
        ...
        <div className="space-y-4 mb-6">
          {assessment.questions.map((question: any, index: number) => (
            ...
            >
              <p
                style={{ color: theme.tColor.light, fontWeight: 600 }}
                className="mb-2"
              >
  ...
  if (submitted) {
    return (
      <ThemeCard theme={theme}>
        ...
        <div
          style={{ background: theme.tDepthColor.light, borderRadius: 16 }}
          className="p-6 mb-6"
        >
          <h3
            style={{ color: theme.tColor.light }}
          ...
          <p style={{ color: theme.tColor.light, whiteSpace: "pre-wrap" }}>
            {response}
          </p>
          <div
            style={{ color: theme.tColor.light, opacity: 0.6 }}
        ...
        <div className="text-center">
          <p
            style={{ color: theme.tColor.light, opacity: 0.8 }}
            className="mb-4"
          >
  ...
  return (
    <ThemeCard theme={theme}>
      ...
      <motion.button
        ...
        style={{
          background:
            response.trim().length >= 50 ? theme.tBorder.light : "#E5E7EB",
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        >
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>
              <b>Personalized Learning:</b> AI can analyze preferences,
              strengths, and gaps to recommend tailored learning paths,
              resources, or projects.
            </li>
            <li>
              <b>Profile Generation:</b> The backend can generate a tech
              profile, visualize interests, and track a student's growth over
              time.
            </li>
            <li>
              <b>Adaptive Challenges:</b> Future activities can be selected or
              adapted based on user strengths and interests.
            </li>
            <li>
              <b>Analytics & Insights:</b> Educators and admins can see
              aggregate data (across users) for domain interest, skill gaps, and
              behavioral trends.
            </li>
            <li>
              <b>AI Recommendations:</b> The data can be streamed to a Kafka
              pipeline for real-time AI processing, clustering similar learners,
              or automating guidance.
            </li>
            <li>
              <b>Feedback Loops:</b> User responses can be used to train AI
              models for better content, detect engagement, or even predict
              success.
            </li>
          </ul>
        </div>
        <div
          ...
          style={{ color: theme.tBorder.light }}
        >
          <strong>Note for Review:</strong> This payload is exactly what will be
          sent to the backend via Kafka for further analytics, profile building,
          and AI-driven adaptive learning.
        </div>
      </div>
    </ThemeCard>
  );
